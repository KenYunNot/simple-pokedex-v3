      ...
      <div className='relative flex flex-col gap-[6vh] w-full h-screen px-3 py-[8vh] bg-gradient-to-b from-pokeballred to-red-500 text-white'>
        <div className='flex flex-col gap-[2vh]'>
          ...
          <div className='flex flex-col gap-[1vh] lg:gap-[3vh]'>
            <h1 className='mt-6 lg:mt-10 text-center text-4xl md:text-5xl lg:text-7xl font-semibold'>
              Pokemon made <span className='text-yellow-400 font-extrabold'>simple</span>
            </h1>
            <p className='text-center italic md:text-lg lg:text-xl'>
